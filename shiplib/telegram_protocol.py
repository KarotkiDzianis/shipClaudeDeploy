...
class ApprovalStore:
    ...
    def create_pending(self, project: str, repo: str, git_sha: str, release_id: str) -> PendingApproval:
        ...
        approve anything again (checked in decide())."""
    ...
    def decide(self, project: str, release_id: str, nonce: str, telegram_user_id: int, decision: str) -> dict:
        ...
        if approval.release_id != release_id or approval.nonce != nonce:
